...
class Camera2Session implements CameraSession {
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onDisconnected(CameraDevice camera) {
            ...
            boolean startFailure = captureSession == null && state != Camera2Session.SessionState.STOPPED;
    ...
    private class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(CameraCaptureSession session) {
            ...
            try {
                ...
                session.setRepeatingRequest(captureRequestBuilder.build(), new Camera2Session.CameraCaptureCallback(), cameraThreadHandler);
            } catch (CameraAccessException var3) {
                CameraAccessException e = var3;
