...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    private final CameraSession.CreateSessionCallback createSessionCallback = new CameraSession.CreateSessionCallback() {
        public void onDone(CameraSession session) {
            ...
            synchronized(stateLock) {
                ...
                cameraStatistics = new CameraVideoCapturer.CameraStatistics(surfaceHelper, eventsHandler);
                firstFrameObserved = false;
                stateLock.notifyAll();
                if (switchState == CameraCapturer.SwitchState.IN_PROGRESS) {
                    switchState = CameraCapturer.SwitchState.IDLE;
    ...
    protected abstract void createCameraSession(CameraSession.CreateSessionCallback var1, CameraSession.Events var2, Context var3, SurfaceTextureHelper var4, String var5, int var6, int var7, int var8, android.os.Handler handler);
