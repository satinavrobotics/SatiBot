...
public class ObjectRenderer {
  ...
  // Shader names.
  private String vertexShaderName = "shaders/ar_object.vert";
  private String fragmentShaderName = "shaders/ar_object.frag";
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
      throws IOException {
    createOnGlThread(context, objAssetName, diffuseTextureAssetName, vertexShaderName, fragmentShaderName);
  }

  /**
   * Creates and initializes OpenGL resources needed for rendering the model with custom shaders.
   *
   * @param context Context for loading the shader and below-named model and texture assets.
   * @param objAssetName Name of the OBJ file containing the model geometry.
   * @param diffuseTextureAssetName Name of the PNG file containing the diffuse texture map.
  ...
  public void createOnGlThread(
      Context context, String objAssetName, String diffuseTextureAssetName,
      String vertexShaderName, String fragmentShaderName) throws IOException {
    // Save the shader names
  ...
  private void compileAndLoadShaderProgram(Context context) throws IOException {
    ...
    final int fragmentShader =
        ShaderUtil.loadGLShader(
            TAG, context, GLES20.GL_FRAGMENT_SHADER, fragmentShaderName, defineValuesMap);
