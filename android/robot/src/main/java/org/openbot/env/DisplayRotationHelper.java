 ...
 * by the display listener, and we need to look them up in the display manager.
 */
public class DisplayRotationHelper implements DisplayListener {
   ...
   * function should be called explicitly before each call to {@link Session#update()}. This function
   * will also clear the 'pending update' (viewportChanged) flag.
   *
