...
public class ImageUtils {
  ...
  private static Bitmap yuvImageToBitmap(Image image) {
    ...
    // Rotate the bitmap if needed based on the image's rotation
    Matrix matrix = new Matrix();
    matrix.postRotate(90); // Most camera images need to be rotated 90 degrees
    return Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, true);
  }

  /**
   * Converts a JPEG image to a bitmap
   */
